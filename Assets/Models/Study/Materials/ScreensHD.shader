	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 temp_output_15_0_g1 = _Tiling;
				float2 break26_g1 = ( packedInput.ase_texcoord5.xy * temp_output_15_0_g1 );
				...
				float simplePerlin3D16 = snoise( temp_cast_0*( ( _TimeParameters.x * 0.05 ) / _Speed ) );
				simplePerlin3D16 = simplePerlin3D16*0.5 + 0.5;
				float clampResult17 = clamp( simplePerlin3D16 , 0.0 , 1.0 );
				float4 lerpResult23 = lerp( _Light , _dark , clampResult17);
				...
				surfaceDescription.Emission = ( lerpResult23 * _EmissionStrength ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 break31_g1 = float2( 0,20000.43 );
				float2 temp_output_15_0_g1 = _Tiling;
				float2 break26_g1 = ( packedInput.ase_texcoord.xy * temp_output_15_0_g1 );
				float2 appendResult27_g1 = (float2(( ( 0.0 * step( 1.0 , ( break26_g1.y % 2.0 ) ) ) + break26_g1.x ) , break26_g1.y));
				float dotResult4_g3 = dot( floor( appendResult27_g1 ) , float2( 12.9898,78.233 ) );
				float lerpResult10_g3 = lerp( break31_g1.x , break31_g1.y , frac( ( sin( dotResult4_g3 ) * 43758.55 ) ));
				float2 break12_g1 = temp_output_15_0_g1;
		...
		Pass
		{
						...
						)
			{
				...
				float2 break31_g1 = float2( 0,20000.43 );
				float2 temp_output_15_0_g1 = _Tiling;
				float2 break26_g1 = ( packedInput.ase_texcoord7.xy * temp_output_15_0_g1 );
				float2 appendResult27_g1 = (float2(( ( 0.0 * step( 1.0 , ( break26_g1.y % 2.0 ) ) ) + break26_g1.x ) , break26_g1.y));
				float dotResult4_g3 = dot( floor( appendResult27_g1 ) , float2( 12.9898,78.233 ) );
				float lerpResult10_g3 = lerp( break31_g1.x , break31_g1.y , frac( ( sin( dotResult4_g3 ) * 43758.55 ) ));
				float2 break12_g1 = temp_output_15_0_g1;
...
/*ASEBEGIN
Version=18400
-74;232;1920;611;1488.715;64.91531;1;True;True
Node;AmplifyShaderEditor.Vector2Node;11;-1750.71,488.8665;Inherit;False;Property;_Tiling;Tiling;2;0;Create;True;0;0;False;0;False;20,20;20,20;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TimeNode;13;-1466.094,752.4257;Inherit;False;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;29;-1277.701,914.8282;Inherit;False;Property;_Speed;Speed;3;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;28;-1181.701,813.8282;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;1000;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;12;-1556.996,490.0264;Inherit;True;Bricks Pattern;-1;;1;7d219d3a79fd53a48987a86fa91d6bac;0;4;15;FLOAT2;20,20;False;14;FLOAT;1;False;16;FLOAT;0;False;17;FLOAT2;0,20000.43;False;2;FLOAT;0;FLOAT;3
Node;AmplifyShaderEditor.NoiseGeneratorNode;16;-1159.035,545.662;Inherit;True;Simplex3D;True;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;-231;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;18;-880.4631,260.9393;Inherit;False;Property;_Light;Light;0;0;Create;True;0;0;False;0;False;1,0.4764151,0.8854613,0;1,0.4764151,0.8854613,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ClampOpNode;17;-903.7302,530.9935;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;21;-1050.963,359.7387;Inherit;False;Property;_dark;dark;1;0;Create;True;0;0;False;0;False;0.1976027,0,0.2358491,0;0.1976027,0,0.2358491,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;31;-426.7152,402.0847;Inherit;False;Property;_EmissionStrength;Emission Strength;4;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;23;-460.8846,191.18;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;-178.061,181.8426;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=173037AD43C6766290AFE19032732924F738AB25